...
namespace MISA.Fresher.Core.Service
{
    ...
    public class BaseService<T> : IBaseService<T>
    {
        ...
        protected virtual void Validate(T entity)
        {
            ...
            {
                // Nếu có
                var attributesRequired = property.GetCustomAttributes(typeof(Required), true); // yêu cầu bắt buộc
                var attributeMaxLength = property.GetCustomAttributes(typeof(MaxSize), true); // yêu cầu độ dài tối đa
